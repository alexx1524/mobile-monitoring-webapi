...
namespace Infotecs.Mobile.Monitoring.Tests
{
    ...
    public class MonitoringDataRepositoryTest
    {
        ...
        [Fact]
        public async Task MonitoringData_Incorrect_data_throws_exception()
        {
            await ClearData();
            ...
            // Assert
            await Assert.ThrowsAsync<PostgresException>(async() => await repository.CreateAsync(data));
        }
        ...
        /// <returns>Задача.</returns>
        [Fact]
        public async Task UpdateMonitoringData_Success_addding()
        {
            await ClearData();
